...
public class PSLocalMap
{
	 ...
	 * @throws SQLException
	 */
	public static PreparedStatement getPS(Connection connection, ThreadLocal<PreparedStatement> psMap, String query, int resultSetType, int resultSetConcurrency)
			throws SQLException
	{
		PreparedStatement ps = psMap.get();
		if (ps == null)
